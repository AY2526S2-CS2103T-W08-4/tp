...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteCommand = "delete id/9999";
        assertCommandException(deleteCommand, String.format(Messages.MESSAGE_PERSON_NOT_FOUND, "9999"));
    }
    ...
    public void execute_validCommand_success() throws Exception {
        ...
        assertCommandSuccess(listCommand, ListCommand.MESSAGE_NO_PERSONS, model);
    }
    ...
    @Test
    public void getAddressBookFilePath_returnsAddressBookFilePath() {
        Path addressBookFilePath = logic.getAddressBookFilePath();
        assertEquals(model.getAddressBookFilePath(), addressBookFilePath);
    }
    ...
    @Test
    public void setGuiSettings_setsGuiSettings() {
        GuiSettings guiSettings = new GuiSettings(500, 600, 1, 2);
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + MEMBERSHIP_EXPIRY_DATE_DESC_AMY;
        Person expectedPerson = new PersonBuilder(AMY).withMembershipExpiryDate(
                getDateNDaysRelativeToToday(285)).build();
